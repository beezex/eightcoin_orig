...
namespace parameters {
  ...
  const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x34cbd0; // addresses start with "intu"
  ...
  const uint64_t START_BLOCK_REWARD                            = (UINT64_C(5) * parameters::POINT);
